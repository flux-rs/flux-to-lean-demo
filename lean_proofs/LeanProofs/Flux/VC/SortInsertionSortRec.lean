...
namespace SortInsertionSortRecKVarSolutions

-- cyclic (cut) kvars
def k0 (a'₃ : (Arr Int)) (a'₄ : Int) (a'₅ : Int) (a'₆ : (Arr Int)) (a'₇ : Int) : Prop :=
  True

end SortInsertionSortRecKVarSolutions


open SortInsertionSortRecKVarSolutions




def SortInsertionSortRec := ∃ k0 : (a0 : (Arr Int)) -> (a1 : Int) -> (a2 : Int) -> (a3 : (Arr Int)) -> (a4 : Int) -> Prop, 
 ∀ (old₀ : (VectorsAVec Int)),
