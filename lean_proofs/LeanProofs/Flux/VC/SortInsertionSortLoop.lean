...
namespace SortInsertionSortLoopKVarSolutions

-- cyclic (cut) kvars
def k0 (a'₃ : Int) (a'₄ : (Arr Int)) (a'₅ : Int) (a'₆ : (Arr Int)) (a'₇ : Int) : Prop :=
  ((a'₃ > 0) ∧ (a'₃ ≥ 0) ∧ (a'₃ ≤ a'₅))

end SortInsertionSortLoopKVarSolutions


open SortInsertionSortLoopKVarSolutions




def SortInsertionSortLoop := ∃ k0 : (a0 : Int) -> (a1 : (Arr Int)) -> (a2 : Int) -> (a3 : (Arr Int)) -> (a4 : Int) -> Prop, 
 ∀ (old₀ : (VectorsAVec Int)),
